...
const checks=[
 ...
 ['packages/novaoryn-ide/src/browser/novaoryn-hardware-widget.tsx',['Hardware / Device Tree','Storage controllers']],
...
console.log('[ OK ] NovaOryn IDE 0.1.53 Dashboard, Kernel Console, Hardware Tree and Test Explorer contracts verified.');
