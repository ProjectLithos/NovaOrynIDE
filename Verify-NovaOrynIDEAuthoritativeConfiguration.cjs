...
if (!service.includes("const NOVAORYN_IDE_VERSION = '0.8.1'")) missing.push('0.8.1 generator version');
if (!widget.includes('NovaOryn OS 0.8.1')) missing.push('0.8.1 configurator version');
