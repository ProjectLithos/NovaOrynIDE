...
if (!service.includes("const NOVAORYN_IDE_VERSION = '0.10.3'")) missing.push('0.10.3 generator version');
if (!widget.includes('NovaOryn OS 0.10.3')) missing.push('0.10.3 configurator version');
