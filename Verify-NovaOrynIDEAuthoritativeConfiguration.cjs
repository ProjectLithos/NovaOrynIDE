...
if (!service.includes("const NOVAORYN_IDE_VERSION = '0.4.6'")) missing.push('0.4.6 generator version');
if (!widget.includes('NovaOryn OS 0.4.6')) missing.push('0.4.6 configurator version');
