...
if (!service.includes("const NOVAORYN_IDE_VERSION = '0.5.0'")) missing.push('0.5.0 generator version');
if (!widget.includes('NovaOryn OS 0.5.0')) missing.push('0.5.0 configurator version');
