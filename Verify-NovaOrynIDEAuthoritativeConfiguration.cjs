...
if (!service.includes("const NOVAORYN_IDE_VERSION = '0.10.0'")) missing.push('0.10.0 generator version');
if (!widget.includes('NovaOryn OS 0.10.0')) missing.push('0.10.0 configurator version');
