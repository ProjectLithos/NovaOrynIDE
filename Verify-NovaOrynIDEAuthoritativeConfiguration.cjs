...
if (!service.includes("const NOVAORYN_IDE_VERSION = '0.1.41'")) missing.push('0.1.41 generator version');
if (!widget.includes('NovaOryn OS 0.1.41')) missing.push('0.1.41 configurator version');
