...
if (!service.includes("const NOVAORYN_IDE_VERSION = '0.9.0'")) missing.push('0.9.0 generator version');
if (!widget.includes('NovaOryn OS 0.9.0')) missing.push('0.9.0 configurator version');
