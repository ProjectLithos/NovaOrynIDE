...
if (!service.includes("const NOVAORYN_IDE_VERSION = '0.3.1'")) missing.push('0.3.1 generator version');
if (!widget.includes('NovaOryn OS 0.3.1')) missing.push('0.3.1 configurator version');
