...
if (!service.includes("const NOVAORYN_IDE_VERSION = '0.4.13'")) missing.push('0.4.13 generator version');
if (!widget.includes('NovaOryn OS 0.4.13')) missing.push('0.4.13 configurator version');
