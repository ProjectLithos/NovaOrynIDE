...
if (!service.includes("const NOVAORYN_IDE_VERSION = '0.8.2'")) missing.push('0.8.2 generator version');
if (!widget.includes('NovaOryn OS 0.8.2')) missing.push('0.8.2 configurator version');
