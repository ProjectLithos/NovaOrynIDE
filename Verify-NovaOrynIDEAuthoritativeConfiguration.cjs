...
if (!service.includes("const NOVAORYN_IDE_VERSION = '0.1.48'")) missing.push('0.1.48 generator version');
if (!widget.includes('NovaOryn OS 0.1.48')) missing.push('0.1.48 configurator version');
