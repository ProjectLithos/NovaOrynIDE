...
if (!service.includes("const NOVAORYN_IDE_VERSION = '0.2.2'")) missing.push('0.2.2 generator version');
if (!widget.includes('NovaOryn OS 0.2.2')) missing.push('0.2.2 configurator version');
