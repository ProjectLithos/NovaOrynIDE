...
if (!service.includes("const NOVAORYN_IDE_VERSION = '0.1.53'")) missing.push('0.1.53 generator version');
if (!widget.includes('NovaOryn OS 0.1.53')) missing.push('0.1.53 configurator version');
