...
if (!service.includes("const NOVAORYN_IDE_VERSION = '0.1.39'")) missing.push('0.1.39 generator version');
if (!widget.includes('NovaOryn OS 0.1.39')) missing.push('0.1.39 configurator version');
