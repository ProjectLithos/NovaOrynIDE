...
if (!service.includes("const NOVAORYN_IDE_VERSION = '0.1.38'")) missing.push('0.1.38 generator version');
if (!widget.includes('NovaOryn OS 0.1.38')) missing.push('0.1.38 configurator version');
