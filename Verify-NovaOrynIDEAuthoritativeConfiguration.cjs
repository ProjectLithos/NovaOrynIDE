...
if (!service.includes("const NOVAORYN_IDE_VERSION = '0.1.49'")) missing.push('0.1.49 generator version');
if (!widget.includes('NovaOryn OS 0.1.49')) missing.push('0.1.49 configurator version');
