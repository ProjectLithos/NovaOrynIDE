...
if (!service.includes("const NOVAORYN_IDE_VERSION = '0.1.37'")) missing.push('0.1.37 generator version');
if (!widget.includes('NovaOryn OS 0.1.37')) missing.push('0.1.37 configurator version');
