...
if (!service.includes("const NOVAORYN_IDE_VERSION = '0.7.3'")) missing.push('0.7.3 generator version');
if (!widget.includes('NovaOryn OS 0.7.3')) missing.push('0.7.3 configurator version');
