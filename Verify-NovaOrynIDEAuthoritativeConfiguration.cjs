...
if (!service.includes("const NOVAORYN_IDE_VERSION = '0.1.46'")) missing.push('0.1.46 generator version');
if (!widget.includes('NovaOryn OS 0.1.46')) missing.push('0.1.46 configurator version');
