...
for(const token of ['Driver Development Centre','Create Driver Project','PCI / PCIe','VirtIO','Requested capabilities']) if(!w.includes(token)){console.error('[FAIL] Driver Centre missing '+token);process.exit(1);}
...
console.log('[ OK ] NovaOryn IDE 0.1.52 Driver Development Centre contract verified.');
