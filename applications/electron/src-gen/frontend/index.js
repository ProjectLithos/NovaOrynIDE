...
FrontendApplicationConfigProvider.set({
    ...
    "electron": {
        "windowOptions": {
            "icon": "resources/novaoryn-ide.ico"
        },
        "showWindowEarly": true,
        "splashScreenOptions": {
            "content": "splash/splash.html",
            "width": 960,
            "height": 540,
            "minDuration": 1200,
            "maxDuration": 30000
        },
        "appUserModelId": "NovaOryn.IDE",
        "uriScheme": "theia"
    },
    "defaultLocale": "",
...
module.exports = (async () => {
    ...
    try {
        ...
        await load(container, import('@novaoryn/ide-extension/lib/browser/novaoryn-frontend-module'));
