...
check(svc.includes("parsed.schemaVersion === 1 && parsed.debugState"),"legacy pre-0.10.3 reader retained");
...
check(docs.includes("Pre-0.10.3") || docs.includes("pre-0.10.3"),"legacy compatibility documented");
