...
Physical transport execution itself remains item 22; 0.2.0 deliberately establishes the persistent target model now so item 22 can plug into it without changing project format.
