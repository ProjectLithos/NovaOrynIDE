...
/// <summary>Standard userland command that requests a system-information summary from the runtime service boundary.</summary>
public static class InfoCommand
{
    public static String GetUsage()=>"info | system";
