...
NovaOryn 0.9.0 establishes the x64 protection boundary required before system calls and processes. Ring 0 remains the kernel privilege level and ring 3 is reserved for user execution.
