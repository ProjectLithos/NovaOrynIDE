...
0.4.9 removes the duplicate declaration and reuses the existing `kernelPhysicalBootstrap` value already loaded earlier in the same policy scope. No runtime memory-management, direct-map, heap, font, Visual Studio or documentation behaviour changes are made in this release.
