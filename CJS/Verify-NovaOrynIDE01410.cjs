...
ok(build.includes('CJS\\Verify-NovaOrynIDE01410.cjs'),'Build invokes the current 0.14.10 release verifier');
ok(!build.includes('CJS\\Verify-NovaOrynIDE0149.cjs'),'Build does not invoke the previous 0.14.7 release verifier');
...
// 0.14.10: never trust a partial node_modules tree merely because Electron exists.
