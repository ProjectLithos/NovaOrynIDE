...
if (!service.includes("const NOVAORYN_IDE_VERSION = '0.13.0'")) missing.push('0.13.0 generator version');
if (!widget.includes('NovaOryn OS 0.13.0')) missing.push('0.13.0 configurator version');
