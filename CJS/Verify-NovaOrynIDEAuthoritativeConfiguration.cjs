...
if (!service.includes("const NOVAORYN_IDE_VERSION = '0.11.12'")) missing.push('0.11.12 generator version');
if (!widget.includes('NovaOryn OS 0.11.12')) missing.push('0.11.12 configurator version');
