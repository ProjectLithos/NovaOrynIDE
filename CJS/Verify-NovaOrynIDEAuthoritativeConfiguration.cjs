...
if (!service.includes("const NOVAORYN_IDE_VERSION = '0.11.16'")) missing.push('0.11.16 generator version');
if (!widget.includes('NovaOryn OS 0.11.16')) missing.push('0.11.16 configurator version');
