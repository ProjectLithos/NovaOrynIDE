...
if (!service.includes("const NOVAORYN_IDE_VERSION = '0.14.17'")) missing.push('0.14.17 generator version');
if (!widget.includes('NovaOryn OS 0.14.17')) missing.push('0.14.17 configurator version');
