...
if (!service.includes("const NOVAORYN_IDE_VERSION = '0.11.15'")) missing.push('0.11.15 generator version');
if (!widget.includes('NovaOryn OS 0.11.15')) missing.push('0.11.15 configurator version');
