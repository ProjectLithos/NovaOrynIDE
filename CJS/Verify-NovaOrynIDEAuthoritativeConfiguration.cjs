...
if (!service.includes("const NOVAORYN_IDE_VERSION = '0.16.1'")) missing.push('0.16.1 generator version');
if (!widget.includes('NovaOryn OS 0.16.1')) missing.push('0.16.1 configurator version');
