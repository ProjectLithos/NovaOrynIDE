...
if (!service.includes("const NOVAORYN_IDE_VERSION = '0.11.10'")) missing.push('0.11.10 generator version');
if (!widget.includes('NovaOryn OS 0.11.10')) missing.push('0.11.10 configurator version');
