...
check(svc.includes("parsed.schemaVersion === 1 && parsed.debugState"),"legacy pre-0.10.11 reader retained");
...
check(docs.includes("Pre-0.10.11") || docs.includes("pre-0.10.11"),"legacy compatibility documented");
