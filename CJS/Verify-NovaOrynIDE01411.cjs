...
ok(build.includes('CJS\\Verify-NovaOrynIDE01411.cjs'),'Build invokes the current 0.14.11 release verifier');
...
// 0.14.11: never trust a partial node_modules tree merely because Electron exists.
...
// 0.14.11: direct manifest verification is authoritative for hoisted workspace packages.
