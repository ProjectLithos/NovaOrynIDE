...
ok(build.includes('CJS\\Verify-NovaOrynIDE0144.cjs'),'Build invokes the current 0.14.4 release verifier');
ok(!build.includes('CJS\\Verify-NovaOrynIDE0142.cjs'),'Build does not invoke the previous 0.14.2 release verifier');
...
ok(build.includes('Manage-NovaOrynIDEPackageLock.ps1') && build.includes('-ExpectedVersion "%NOVAORYN_IDE_VERSION%"'),'Build delegates package-lock version handling to a dedicated PowerShell file');
...
ok(build.includes('CJS\\Verify-NovaOrynIDE0144.cjs'),'Build invokes the current 0.14.4 release verifier');
ok(!build.includes('CJS\\Verify-NovaOrynIDE0143.cjs'),'Build does not invoke the previous 0.14.3 release verifier');
