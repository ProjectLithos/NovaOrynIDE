...
requireText('packages/novaoryn-ide/src/browser/novaoryn-hardware-widget.tsx', [
  "static readonly ID = 'novaoryn.hardware.document'", "static readonly LABEL = 'Hardware / Device Tree'",
...
console.log('[ OK ] Unified device model: PCI, USB, ACPI, platform, virtual, logical; one hierarchical contract is used by kernel and IDE Hardware Tree, which opens as a main document tab.');
