...
ok(build.includes('CJS\\Verify-NovaOrynIDE0149.cjs'),'Build invokes the current 0.14.9 release verifier');
ok(!build.includes('CJS\\Verify-NovaOrynIDE0147.cjs'),'Build does not invoke the previous 0.14.7 release verifier');
