...
ok(build.includes('CJS\\Verify-NovaOrynIDE01412.cjs'),'Build invokes the current 0.14.12 release verifier');
...
// 0.14.12: never trust a partial node_modules tree merely because Electron exists.
...
// 0.14.12: direct manifest verification is authoritative for hoisted workspace packages.
...
// 0.14.12: hoisted dev dependencies use the same authoritative direct-manifest verification as runtime dependencies.
