...
ok(build.includes('CJS\\Verify-NovaOrynIDE0145.cjs'),'Build invokes the current 0.14.5 release verifier');
ok(!build.includes('CJS\\Verify-NovaOrynIDE0144.cjs'),'Build does not invoke the previous 0.14.4 release verifier');
