    ...
    protected render(): React.ReactNode {
        return <div className='novaoryn-tool-page'>
            ...
            {this.root() && <>
                ...
                <section className='novaoryn-target-note'><h3>Execution contract</h3><p>QEMU x86_64 targets support Run and Debug. Physical x86_64 targets support Debug through the NovaOryn 0.10.11 GDB RSP physical-machine transport, with optional COM-port serial capture. ARM64/RISC-V and generic remote-agent execution remain stored/configurable until their architecture/transport backends are installed.</p></section>
            </>}
        </div>;
    }
}
