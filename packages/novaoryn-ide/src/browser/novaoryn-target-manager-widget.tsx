    ...
    protected render(): React.ReactNode {
        return <div className='novaoryn-tool-page'>
            ...
            {this.root() && <>
                ...
                <section className='novaoryn-target-note'><h3>Execution contract</h3><p>QEMU x86_64 targets are applied to Run/Debug now. ARM64/RISC-V and physical/remote targets are stored and selectable, but launch is rejected cleanly until the matching architecture and item 22 physical debugger transport are available.</p></section>
            </>}
        </div>;
    }
}
