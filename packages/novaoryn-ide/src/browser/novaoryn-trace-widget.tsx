...
export class NovaOrynTraceWidget extends ReactWidget {
    ...
    protected render(): React.ReactNode {
        ...
        return <div className='novaoryn-tool-page'>
            ...
            <p className='novaoryn-telemetry-help'>Structured kernel telemetry is accepted as <code>[NOVAORYN:TRACE] category=scheduler name=context-switch cpu=0</code>, <code>[NOVAORYN:BOOT] stage="Drivers" phase=end ms=12.4</code>, and profiler telemetry consumed by the Performance Profiler.</p>
        </div>;
    }
}
