...
export class NovaOrynWidget extends BaseWidget {
    ...
    protected renderStartup(): void {
        ...
        card.appendChild(this.element('h1', undefined, 'NovaOryn IDE 0.7.5'));
    ...
    protected renderConfiguration(): void {
        ...
        card.appendChild(this.element('h1', undefined, this.reconfiguringProjectPath ? `Reconfigure ${c.name}` : 'NovaOryn OS 0.7.5'));
