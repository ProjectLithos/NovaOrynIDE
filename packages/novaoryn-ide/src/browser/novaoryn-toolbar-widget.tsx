    ...
    protected render(): React.ReactNode {
        ...
        return <div className='novaoryn-run-toolbar'>
            ...
            {debug && <div className='novaoryn-debug-controls' aria-label='NovaOryn debugger controls'>
                ...
                <button className='novaoryn-debug-button' disabled={!hasWorkspace} title='Show Exception Breakpoints, Watch, Memory, Page Tables, Kernel Heap, Crash Dumps, Mixed Disassembly, Named Locals/Arguments, Call Stack and Registers' onClick={() => this.showDebugInspector()}>
